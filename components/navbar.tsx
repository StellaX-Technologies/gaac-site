...
const Navbar = () => {
  ...
  return (
    <nav className="flex flex-col items-center justify-center lg:bg-navbar lg:bg-opacity-11 mt-[2.0625rem] p-6 rounded-3xl max-w-[81.8125rem] mx-auto w-full">
      <div className="flex items-center justify-between w-full">
        ...
        <div className={`lg:flex lg:items-center lg:justify-between w-full ${isOpen ? 'block' : 'hidden'}`}>
          <a href="#responsive-header" className="block m-2 ml-[3.125rem] lg:inline-block text-white font-bold hover:drop-shadow-xl">
            Home
          </a>
